...
function Server({ serverRequest ,getWorkSpaceDetails }) {
  ...
  useEffect(() => {
    if(!reduxState?.workspace?.server && isSubmitted) {
      ...
      setServer({ ...server, form: { ...server?.form, server: reduxState?.workspace?.server?.id ? {...reduxState?.workspace?.server} : {...server?.form?.server, server_name: reduxState?.user?.profile?.first_name+"Cloud" } } });
    }
    setSubmitted(false);
    return () => {};
  ...
  const submitHandler = (e) => {
    ...
    if (validateServerDetails()) {
      setLoader(true);
      serverRequest({...server?.form ,userId : localStorage.getItem("userId") });
    }
  };
  ...
  return (
    <Wrapper>
      ...
      <GridContainer spacing={1}>
        ...
        <Typography  gutterBottom={2} align="left" variant="subtitle1" color="secondary">Network Configuration</Typography>
             <Box className={classes.boxModal} borderColor="#e7e9f0" border={.5}>
              ...
              <GridContainer spacing={3}>
                <GridItem xs={12}>
                  ...
                  <GridContainer spacing={1}>
                    ...
                    <GridItem xs={8}>
                      <Typography variant="subtitle2" color="textSecondary">{NETWORK.name}</Typography>
                    </GridItem>
                    <GridItem xs={4}>
        ...
        <GridItem xs={12} sm={6} md={6}>
        <Typography  gutterBottom={2} align="left" variant="subtitle1" color="secondary">Size Configuration</Typography>
             <Box className={classes.boxModal} borderColor="#e7e9f0" border={.5}>
                <GridContainer spacing={1}>
                <GridItem xs={12}>
                   <GridContainer spacing={1}>
                      ...
                      <GridItem xs={8}>
                        <Typography variant="subtitle2" color="textSecondary">{FLAVOR?.size?.ram}</Typography>
                      </GridItem>
                      <GridItem xs={4}>
                        <Typography >CPUs</Typography>
                      </GridItem>
                      <GridItem xs={8}>
                        <Typography variant="subtitle2" color="textSecondary">{FLAVOR.size?.cpu}</Typography>
                      </GridItem>
                      <GridItem xs={4}>
        ...
        <Typography  gutterBottom={2} align="left" variant="subtitle1" color="secondary">Image Template</Typography>
             <Box className={classes.boxModal} borderColor="#e7e9f0" border={.5}>
              ...
              <GridContainer spacing={1}>
                ...
                <GridItem xs={12}>
                  <GridContainer spacing={1}>
                    ...
                    <GridItem xs={7}>
                      <Typography variant="subtitle2" color="textSecondary">Engineero-workspace</Typography>
                    </GridItem>
                  </GridContainer>
                </GridItem>
                <GridItem xs={12}>
                ...
                <GridItem item xs={12}>
                  <GridContainer spacing={1}>
                    ...
                    <GridItem xs={7}>
                      {" "}
                      <Typography variant="subtitle2" color="textSecondary">{IMAGE?.os_type}</Typography>
                    </GridItem>
                  </GridContainer>
                </GridItem>
        ...
        <GridItem xs={12} sm={6} md={6}>
        <Typography  gutterBottom={2} align="left" variant="subtitle1" color="secondary">Compute Configuration</Typography>
             <Box className={classes.boxModal} borderColor="#e7e9f0" border={.5}>
        ...
        </GridItem>
        {
         ...
         <GridItem xs={12} sm={6} md={6}>
        <Typography  gutterBottom={2} align="left" variant="subtitle1" color="secondary">Server Details</Typography>
             <Box className={classes.boxModal} borderColor="#e7e9f0" border={.5}>
