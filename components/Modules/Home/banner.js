...
export default function Banner(props) {
    ...
    return (
        <div>
           <Carousel showArrows={true}  showIndicators={true}  infiniteLoop={true} interval={3000} >
             <Grid container spacing={2} className={classes.secondBox} justifyContent="center" direction='row' alignItems="center">
                <Grid xs={7} sm={6}>
            ...
            <Grid container spacing={2} className={classes.secondBox} justifyContent="center" direction='row' alignItems="center">
                <Grid xs={7} sm={6}>
                    <Box className={classes.firstLeftBox}>
                        ...
                        <Typography color="secondary" variant="subtitle2" component="h6" gutterBottom className={classes.boxHeading2}>
