    ...
    <div>
      ...
      <GridContainer spacing={1}>
          ...
          <Card>
            ...
            <CardBody>
              <GridContainer spacing={3}>
                <GridItem xs={4}>
                  <TextField name='first_name' fullWidth label='First Name' />
                </GridItem>
                <GridItem xs={4}>
                ...
                <GridItem xs={4}>
                  <TextField fullWidth disabled={true} name='user_name' type='text' label='UserName' />
                </GridItem>
                <GridItem xs={4}>
                  <TextField
                    fullWidth
        ...
        <GridItem xs={12}>
          <Card>
            ...
            <CardBody>
              <GridContainer spacing={3}>
                <GridItem xs={4}>
                  <TextField name='company_name' fullWidth label='Company Name' />
                </GridItem>
                <GridItem xs={4}>
        ...
        <GridItem xs={12} sm={12} md={12} align='right' alignContent='flex-end'>
          <Button type='button' variant='contained' color='primary' className={classes.submit} onClick={submitHandler}>
            Save Changes
          </Button>
        </GridItem>
      </GridContainer>
